        ...
        classesForDay.length > 0 ? (
          <Popover key={day}>
            <PopoverTrigger asChild>
              <div
                className={`h-12 flex flex-col items-center justify-center text-sm rounded-lg cursor-pointer transition-all duration-300 ease-out transform-gpu border ${isToday
          ...
          <div
            key={day}
            className={`h-12 flex flex-col items-center justify-center text-sm rounded-lg transition-colors border ${isToday
                ? 'bg-primary text-primary-foreground font-semibold border-primary shadow-sm'
